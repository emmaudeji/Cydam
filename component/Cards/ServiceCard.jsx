...
const ServiceCard = ({text, linktext, icon, link, title}) => {
  return (
    <div className={" text-white p-6 h-full w-full flex gap-4 border-4 border-blue-400 rounded-[70px] items-center rounded-tl-none hover:shadow-2xl duration-300"}>
